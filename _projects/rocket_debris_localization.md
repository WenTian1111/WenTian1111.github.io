...
<div class="row justify-content-center">
    <div class="col-md-6 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/rocket/devices_global.png" title="Seven monitoring devices" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-center">
    <div class="col-md-6 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/rocket/problem1_localization.png" title="Single-debris localization" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-center">
    <div class="col-md-6 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/rocket/problem4_error.png" title="Error simulation" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    <em>Figure 5.</em> Positioning stability under simulated device recording errors.
</div>
