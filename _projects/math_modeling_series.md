...
<div class="caption">
    Schematic: users are segmented into behaviour clusters and each segment receives tailored app recommendations.
</div>
...
<div class="caption">
    Schematic: matching wind–solar generation with load, with the battery absorbing surplus and releasing it at peak hours.
</div>
...
<div class="caption">
    Schematic: the linked dragon chain winding along the 55 cm-pitch spiral; every joint position and speed is computed per second.
</div>
...
<div class="caption">
    Schematic: from the last known position, the drift model expands a probability region that guides the search pattern.
</div>
...
<div class="caption">
    Schematic: FE mesh of the brain section with a surgical window and retraction force, tracking lesion displacement.
</div>
...
<div class="caption">
    Schematic: a one-stroke (Eulerian) tool tour that visits every contour while minimizing idle travel.
</div>
...
<div class="caption">
    Schematic: the smoke cloud intersects the missile–target line of sight; the PSO-optimized drop and detonation maximize occlusion time.
</div>

---

*Competition series: served as team leader or independent researcher across these challenges, earning first-class awards at national and provincial levels (2023–2025). Figures are schematic illustrations of the modeling approach.*
