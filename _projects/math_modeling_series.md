...
period: 2023–2026
question: How can real-world constraints be translated into useful mathematical models?
role: Team leader and independent contributor across competition projects
methods: Numerical simulation, optimization, statistics, computational geometry
outcome: Seven competition case studies
card_summary: Models of energy dispatch, biomechanics, search planning, and other applied problems developed through mathematical modeling competitions.
image_alt: Overview of seven applied mathematical modeling challenges
---
...
_Competition series: served as team leader or independent researcher across these challenges, earning first-class awards at national and provincial levels (2023–2025). Figures are schematic illustrations of each modeling approach._
