...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "nav-certificates-amp-honors",
          ...
          title: "cv",
          description: "This page provides a comprehensive overview of my academic background, research experience, and professional skills. You can download the latest version of my CV by clicking the PDF icon.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-machine-vision-for-coupled-egg-dynamics-amp-intelligent-sorting",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%79%68%31%36%36%32%33%34%32%33%38%34%33@%65%6D%61%69%6C.%73%77%75.%65%64%75.%63%6E", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/WenTian1111", "_blank");
        },
      },{
      id: 'light-theme',
